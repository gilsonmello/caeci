...
class Element {
	...
	get_information = ()=> `clicked ('${this.name}, ${this.family},<Br>${this.family2},<Br>Símbolo: ${this.acronym},<Br>Número atômico: ${this.number},<Br> Configuração de Valência: ${this.valency},<Br> Massa atômica: ${this.mass} u', true)`;
